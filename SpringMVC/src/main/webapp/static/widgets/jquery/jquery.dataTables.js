...
(/** @lends <global> */function( $ ) {
	...
	function _fnColumnOptions( oSettings, iCol, oOptions )
	{
		...
		var _fnDataFormat=function(datatype){
			
			if(datatype=="date")
			{
				var returnfunction=function(data, type, row) {
					return new Date(data).Format("yyyy-MM-dd");
				};
				return _fnGetObjectDataFn(returnfunction);
...
//				return _fnGetObjectDataFn(returnfunction);
		...
		var mDataFormat=oCol.datatype ? _fnDataFormat(oCol.datatype):null;
		...
		oCol.fnGetData = function (oData, sSpecific) {
			...
			if(oCol.datatype && (sSpecific && sSpecific !== ''))
			{
				innerData= mDataFormat(innerData, sSpecific, oData );
			}
